...
VALUES ('151916c4-291c-4125-9ae7-d045eeece9ee', 'John Ranger', 'JohnnyR');
INSERT INTO member(member_id, member_name, member_nickname)
...
INSERT INTO fitness_class(id, name, coach_id, start_time, end_time)
VALUES ('051916c4-291c-4125-9ae7-d045eeece9ea', 'Fitness Class 1', SELECT coach_id from coach where name = 'Coach1', '2024-06-25 13:00:00', '2024-06-25 15:00:00');

INSERT INTO fitness_class(id, name, coach_id, start_time, end_time)
VALUES ('b7b57d69-d9d0-43bf-a30e-39f682853269', 'Fitness Class 2', SELECT coach_id from coach where name = 'Coach2', '2024-06-25 13:00:00', '2024-06-25 15:00:00');

INSERT INTO fitness_class(id, name, coach_id, start_time, end_time)
VALUES (UUID(), 'Fitness Class 3', SELECT coach_id from coach where name = 'Coach1', '2024-06-26 15:00:00', '2024-06-26 17:00:00');

INSERT INTO fitness_class(id, name, coach_id, start_time, end_time)
VALUES (UUID(), 'Fitness Class 4', SELECT coach_id from coach where name = 'Coach2', '2024-06-26 15:00:00', '2024-06-26 16:00:00');
